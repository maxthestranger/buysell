...
const createTables = () => {
    ...
    db.transaction(tx => {
        ...
        tx.executeSql(
            'CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, user_id INTEGER NOT NULL, price REAL NOT NULL, description TEXT NOT NULL, status TEXT NOT NULL, image TEXT NOT NULL)'
        );
        tx.executeSql(
        ...
        tx.executeSql(
            'CREATE TABLE IF NOT EXISTS purchase_requests (id INTEGER PRIMARY KEY AUTOINCREMENT, buyer_id INTEGER NOT NULL, user_id INTEGER NOT NULL, status TEXT NOT NULL, product_id INTEGER NOT NULL)'
        );
    });
};
